...
if submit_button:
    prompt_parts = [
        f"I need clearly understanding of the dreams that the user has given to you and give a emotional analysis and a mental analysis of the person. Don't give your own personal meaning of the dream just the analysis of what the condition of the person is.{dream_description}",
    ]
